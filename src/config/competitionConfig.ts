  ...
  contributors: [
    {
      id: 'contrib-1',
      name: 'Dillan Garner',
      role: 'NCSSM Physics Club President, Cofounder, Logistics Lead',
      affiliation: 'NCSSM',
    ...
    },
    {
      id: 'contrib-3',
      name: 'David Osinuga',
      role: 'NCSSM Physics Club Vice President, Cofounder, Logistics Lead, Web Developer',
      affiliation: 'NCSSM',
    ...
    },
    {
      id: 'contrib-4',
      name: 'Pranava Kumar',
      role: 'NCSSM Physics Club Co-President, Marketing Lead',
      affiliation: 'NCSSM',
    ...
    },
    {
        id: 'contrib-5',
        name: 'Alan Cai',
        role: 'NCSSM Physics Club Marketing Director, NCPhO Marketing Lead',
        affiliation: 'NCSSM',
      ...
      },
      {
        id: 'contrib-7',
        name: 'Baya Belgaied',
        role: 'NCSSM Physics Club Competition Director, Director of Outreach for NCPhO',
        affiliation: 'NCSSM',
      ...
      },
      {
        id: 'contrib-8',
        name: 'Colin Xu',
        role: 'Treasurer of NCSSM Physics Club',
        affiliation: 'NCSSM',
      ...
      },
      {
        ...
        role: 'Director of Outreach for NCPhO, Academic Lead for NCPhO',
        affiliation: 'NCSSM',
      ...
      },
      {
        id: 'contrib-11',
        name: 'Raghav Arun',
        role: 'Director of Outreach for NCPhO',
        affiliation: 'NCSSM',
